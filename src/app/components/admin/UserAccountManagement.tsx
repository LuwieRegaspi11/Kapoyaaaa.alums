...
function mapRow(r: any): UserAccount {
  ...
  if (r.registration_status === 'pending') status = 'Pending';
                ...
                <tr key={u.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      ...
                      <button title="Reset Password (not yet implemented)" className="p-1.5 rounded-lg hover:bg-blue-50 text-blue-600 transition-colors opacity-40 cursor-not-allowed">
