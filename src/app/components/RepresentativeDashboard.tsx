...
import { BarChart3, Users, DollarSign, Calendar, Megaphone, BriefcaseBusiness, Shield, CheckCircle, Search, Clock, TrendingUp, Send } from 'lucide-react';
...
// -- 6. Representative-only sub-pages (routed below) -------------------
