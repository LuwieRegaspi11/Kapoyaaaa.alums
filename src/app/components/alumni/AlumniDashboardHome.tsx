        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {user?.registrationStatus !== 'pending' && (
            <button
              ...
              className="flex-shrink-0 flex items-center justify-center gap-2 bg-white text-[#1B3A6B] font-bold text-sm px-5 py-2.5 rounded-xl shadow-lg hover:bg-white/90 active:scale-[0.98] transition-all w-full sm:w-auto"
            >
              <DollarSign className="w-4 h-4" /> Make a Donation
            </button>
          )}
        </div>
      </div>
