...
import { Users, TrendingUp, DollarSign, FileText, Calendar, LogOut, BarChart3, Shield, Bell, UserCheck, UserCog, ChevronRight, Menu, X, Megaphone, Building2, Settings, BookOpen, Sun, Moon, User, Search, Download, UserPlus, Eye, Edit, Trash2, FileSpreadsheet, Archive, CheckCircle, Filter, Plus, Pin, XCircle, Power, Clock, MapPin, Upload, GraduationCap, Globe, CreditCard, Mail, Save, Phone, AtSign, Link, Palette, Send, RefreshCw } from 'lucide-react';

// -- 4. Third-party UI libraries ---------------------------------------
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TextField, Button, Select, MenuItem, FormControl, InputLabel, Chip, Dialog, DialogTitle, DialogContent, DialogActions, Card, CardContent, Avatar, LinearProgress, Tabs, Tab, Box } from '@mui/material'; // Material UI — tables, dialogs, form fields
import { BarChart, Bar, PieChart, Pie, Cell, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, LineChart, Line } from 'recharts'; // charts on the dashboard overview
